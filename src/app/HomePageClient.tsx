...
const T = {
  en: {
    ...
    wyg: {
      ...
      s2Body: "Your client gets a personal portal with all 3 plans — each with a proportional floor-plan diagram, a cost range, and an interactive mortgage calculator they can adjust. They can request pre-qualification, book a meeting, or tap \"I'm interested\" — and you get an instant email notification. You also see the moment they open it.",
  ...
  es: {
    ...
    customPrice: "Para más de 50 empleados",
    ...
    wyg: {
      ...
      note: "Hecho por un fundador en solitario. Sin agencia de diseño. Sin relleno.",
      sec: "~30 seg",
      ...
      s2Body: "Tu cliente recibe un portal personal con las 3 propuestas — cada una con un diagrama proporcional del plano, un rango de costo y una calculadora de hipoteca interactiva que puede ajustar. Puede solicitar precalificación, agendar una reunión o tocar \"Me interesa\" — y recibes una notificación por email al instante. También ves el momento en que lo abre.",
      ...
      s3bBody: "Conecta tu propia licencia MLS vía Trestle para autocompletar el tamaño real del lote y la zonificación en cada concepto. Conforme con NAR/IDX — cada consulta queda registrada en auditoría. Requiere tu propia licencia MLS.",
    },
    modal: {
      redirecting: "Redirigiendo…",
      freeTitle: "Has usado tus 3 propuestas gratis de este mes",
      freeBody: "Tu plan gratis incluye 3 generaciones de planos al mes. Mejora a Pro para 100/mes, tu propia marca y datos MLS.",
      freeCta: "Iniciar prueba Pro — $49/mes",
      proTitle: "Alcanzaste tu límite de 100/mes",
      proBody: "El plan Equipo te da generaciones ilimitadas (uso justo), hasta 15 usuarios y PDF sin marca.",
      proCta: "Mejora a Equipo — $149/mes",
