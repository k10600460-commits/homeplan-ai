          ...
          <div className="space-y-10 text-slate-700">
            ...
            <section id="fair-use">
              ...
              <p className="leading-relaxed mb-3">
                ...
                customer. &ldquo;Unlimited&rdquo; means that, under ordinary use, we do not apply a fixed
                monthly generation quota to these plans.
              </p>
              <p className="leading-relaxed mb-3">
                To keep SplanAI fast, reliable, and affordable for everyone, &ldquo;unlimited&rdquo; use is
                subject to fair use. Usage is considered outside of fair use if it is not
                consistent with normal individual or team business use of the Service — for
                example, if it is:
              </p>
              <ul className="list-disc pl-6 space-y-1 leading-relaxed mb-3">
                <li>automated, scripted, or generated by bots rather than by people;</li>
                <li>used to resell or redistribute SplanAI&rsquo;s output, or to provide the Service to
                    parties outside your subscribing organization;</li>
                <li>shared across more individuals or organizations than your plan&rsquo;s seat
                    allowance permits;</li>
                <li>substantially and persistently in excess of typical usage by comparable
                    customers; or</li>
                <li>intended to disrupt, overload, or circumvent the limits of the Service.</li>
              </ul>
              <p className="leading-relaxed mb-3">
                If your usage falls outside fair use, we will, where practical, contact you
                first — for example, to help you find a plan that better fits your needs, or to
                ask you to bring usage back within normal patterns. We reserve the right to
                apply reasonable rate limits, temporarily restrict generation, or, in cases of
                clear abuse, suspend access, in order to protect the Service and other
                customers. We will act reasonably and proportionately, and we will not restrict
                genuine, good-faith business use of your plan.
              </p>
              <p className="leading-relaxed">
                We may update this Fair Use Policy from time to time. Material changes will be
