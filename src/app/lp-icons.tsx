// Landing-page icon set — one stroke system, currentColor (DESIGN.md).
// Language-independent: kept out of the i18n T object so EN/ES can never drift.
...
export const PAIN_ICONS: IconName[] = ["clock", "layout", "inbox"];
export const HOW_ICONS: IconName[] = ["clipboard", "layers", "link"];
export const DIFF_ICONS: IconName[] = ["mappin", "doc", "eye", "sliders", "grid", "refresh"];
